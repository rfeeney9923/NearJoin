...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<edu.ohio_state.cse.nearjoin.eventbackend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, edu.ohio_state.cse.nearjoin.eventbackend.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String userName, java.lang.String password, java.lang.String userURL, java.lang.String phone) throws java.io.IOException {
    Register result = new Register(regId, userName, password, userURL, phone);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{userName}/{password}/{userURL}/{phone}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String userName, java.lang.String password, java.lang.String userURL, java.lang.String phone) {
      ...
      this.userURL = com.google.api.client.util.Preconditions.checkNotNull(userURL, "Required parameter userURL must be specified.");
    ...
    public Register setUserURL(java.lang.String userURL) {
