 ...
 * on 2014-11-18 at 01:08:31 UTC 
 * Modify at your own risk.
 */

package edu.ohio_state.cse.nearjoin.eventbackend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "sendEvent".
   *
   * This request holds the parameters needed by the messaging server.  After setting any optional
   * parameters, call the {@link SendEvent#execute()} method to invoke the remote operation.
   *
   * @param eventTitle
   * @param regId
   * @return the request
   */
  public SendEvent sendEvent(java.lang.String eventTitle, java.lang.String regId) throws java.io.IOException {
    SendEvent result = new SendEvent(eventTitle, regId);
    initialize(result);
    return result;
  }

  public class SendEvent extends MessagingRequest<Void> {

    private static final String REST_PATH = "message/sendEvent";

    /**
     * Create a request for the method "sendEvent".
     *
     * This request holds the parameters needed by the the messaging server.  After setting any
     * optional parameters, call the {@link SendEvent#execute()} method to invoke the remote
     * operation. <p> {@link
     * SendEvent#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param eventTitle
     * @param regId
     * @since 1.13
     */
    protected SendEvent(java.lang.String eventTitle, java.lang.String regId) {
      super(Messaging.this, "POST", REST_PATH, null, Void.class);
      this.eventTitle = com.google.api.client.util.Preconditions.checkNotNull(eventTitle, "Required parameter eventTitle must be specified.");
      this.regId = com.google.api.client.util.Preconditions.checkNotNull(regId, "Required parameter regId must be specified.");
    }

    @Override
    public SendEvent setAlt(java.lang.String alt) {
      return (SendEvent) super.setAlt(alt);
    }

    @Override
    public SendEvent setFields(java.lang.String fields) {
      return (SendEvent) super.setFields(fields);
    }

    @Override
    public SendEvent setKey(java.lang.String key) {
      return (SendEvent) super.setKey(key);
    }

    @Override
    public SendEvent setOauthToken(java.lang.String oauthToken) {
      return (SendEvent) super.setOauthToken(oauthToken);
    }

    @Override
    public SendEvent setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendEvent) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendEvent setQuotaUser(java.lang.String quotaUser) {
      return (SendEvent) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendEvent setUserIp(java.lang.String userIp) {
      return (SendEvent) super.setUserIp(userIp);
    }
    ...
    public SendEvent setEventTitle(java.lang.String eventTitle) {
    ...
    public SendEvent setRegId(java.lang.String regId) {
      this.regId = regId;
      return this;
    }

    @Override
    public SendEvent set(String parameterName, Object value) {
      return (SendEvent) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "sendEvents".
   *
   * This request holds the parameters needed by the messaging server.  After setting any optional
   * parameters, call the {@link SendEvents#execute()} method to invoke the remote operation.
   *
   * @param category
   * @param distance
   * @param regId
   * @return the request
   */
  public SendEvents sendEvents(java.lang.Integer category, java.lang.Double distance, java.lang.String regId) throws java.io.IOException {
    SendEvents result = new SendEvents(category, distance, regId);
    initialize(result);
    return result;
  }

  public class SendEvents extends MessagingRequest<Void> {

    private static final String REST_PATH = "message/sendEvents";

    /**
     * Create a request for the method "sendEvents".
     *
     * This request holds the parameters needed by the the messaging server.  After setting any
     * optional parameters, call the {@link SendEvents#execute()} method to invoke the remote
     * operation. <p> {@link
     * SendEvents#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param category
     * @param distance
     ...
     * @since 1.13
     */
    protected SendEvents(java.lang.Integer category, java.lang.Double distance, java.lang.String regId) {
      super(Messaging.this, "POST", REST_PATH, null, Void.class);
    ...
    @Override
    public SendEvents setAlt(java.lang.String alt) {
      return (SendEvents) super.setAlt(alt);
    }

    @Override
    public SendEvents setFields(java.lang.String fields) {
      return (SendEvents) super.setFields(fields);
    }

    @Override
    public SendEvents setKey(java.lang.String key) {
      return (SendEvents) super.setKey(key);
    }

    @Override
    public SendEvents setOauthToken(java.lang.String oauthToken) {
      return (SendEvents) super.setOauthToken(oauthToken);
    }

    @Override
    public SendEvents setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendEvents) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendEvents setQuotaUser(java.lang.String quotaUser) {
      return (SendEvents) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendEvents setUserIp(java.lang.String userIp) {
      return (SendEvents) super.setUserIp(userIp);
    }
    ...
    public SendEvents setCategory(java.lang.Integer category) {
    ...
    public SendEvents setDistance(java.lang.Double distance) {
    ...
    public SendEvents setRegId(java.lang.String regId) {
      this.regId = regId;
      return this;
    }

    @Override
    public SendEvents set(String parameterName, Object value) {
      return (SendEvents) super.set(parameterName, value);
    }
  }
