...
public class GcmAddParticipantAsyncTask extends AsyncTask<ArrayList<String>, Void, String> {
    ...
    protected String doInBackground(ArrayList<String>... params) {
        ...
        msg = "add participant successfully";
...
//java.lang.String participant, java.lang.String title
            eventService.addParticipant(participant, event_title).execute();
