...
public class DatabaseHelper {
   private static final String DATABASE_NAME = "NearJoin.db";
   ...
   public DatabaseHelper(Context context) {
      ...
      NearJoinSQLOpenHelper openHelper = new NearJoinSQLOpenHelper(this.context);
   ...
   private static class NearJoinSQLOpenHelper extends SQLiteOpenHelper {
	   NearJoinSQLOpenHelper(Context context) {
